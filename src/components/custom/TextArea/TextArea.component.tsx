...
const CustomTextArea: FunctionComponent<CustomTextAreaProps> = (props:CustomTextAreaProps):JSX.Element => {
    ...
    return (
        <Flex direction="flex-col" className={`gap-1 text-black w-full`}>
            ...
            <Flex item="items-center" className={`w-full bg-white-light border overflow-hidden rounded-lg ${props.success ? "border-success" : ""} ${props.error ? "border-danger-light" : ""} ${isFocused ? "border-primary" : ""}`}>
                ...
                <textarea
                    className={`
                        py-2 px-4 focus:outline-none flex-1 border-none
